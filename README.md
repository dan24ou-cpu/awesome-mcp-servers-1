...
- [AgentSignal](https://github.com/dan24ou-cpu/agent-signal) - Collective intelligence for AI shopping agents. 23 MCP tools for buyer intelligence, seller analytics, price alerts, and trend tracking. Every agent that connects makes every other agent smarter.
